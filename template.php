...
<body>
    ...
    <div class="container">
        ...
        <div class="side">
                ...
                <div class="logText"><span class="log"><i class="fa-solid fa-bars"></i></span><span class="contText">Dashboard</span></div>
        ...
        <div class="page">
            <div class="bup">
                <div>
                    <div class="burger"><img src="logoS.png" alt="burger"></div>
                    <div class="menu"><img src="logoS.png" alt="menu"></div>
                    <div class="input">
                        <span class="icon"><ion-icon name="lock-closed-outline"></ion-icon></span>
                        <input type="password" name="password" required placeholder="Recherche par matricule">
                    </div>
                </div>
                <div>
                    <div class="jour">
                       <span> <img src="" alt="cal"></span> 20 March 2024
                    </div>
                    <div class="profile">
                        <div class="tof"><img src="" alt="tof"></div>
                        <div class="tlUser">
